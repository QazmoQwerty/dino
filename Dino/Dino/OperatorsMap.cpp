...
void OperatorsMap::setup()
{
	...
	*/
	...
	_map["="]	= { OT_ASSIGN_EQUAL,			"=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["+="]	= { OT_ASSIGN_ADD,				"+=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["-="]	= { OT_ASSIGN_SUBTRACT,			"-=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["*="]	= { OT_ASSIGN_MULTIPLY,			"*=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["/="]	= { OT_ASSIGN_DIVIDE,			"/=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["%="]	= { OT_ASSIGN_MODULUS,			"%=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["<<="]	= { OT_ASSIGN_SHIFT_LEFT,		"<<=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map[">>="]	= { OT_ASSIGN_SHIFT_RIGHT,		">>=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["&="]	= { OT_ASSIGN_BITWISE_AND,		"&=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["?="]	= { OT_ASSIGN_BITWISE_OR,		"?=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map["^="]	= { OT_ASSIGN_BITWISE_XOR,		"^=",	RIGHT_TO_LEFT,		20,		NONE,	NONE };
	_map[","]	= { OT_COMMA,					",",	LEFT_TO_RIGHT,		10,		NONE,	NONE };
