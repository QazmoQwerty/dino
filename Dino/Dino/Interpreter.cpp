...
//
//	bool isMethod = false;
//	if (params.size() != 0 && params[0]->getVarId() == "this")
//	{
//		isMethod = true;
...
//		for (auto modifier : decl->getVarType()._prefixModifiers)
//			vtd.modifiers.push_back(modifier);
//		vtd.type = decl->getVarType()._typeName;	// Temp?
//		typeDef._variables[decl->getVarId()] = vtd;
//	}
//	for (auto propDecl : node->getPropertyDeclarations())
//	{
//		PropertyDefinition propDef;
//		for (auto modifier : propDecl->getVarDecl()->getVarType()._prefixModifiers)
//			propDef.modifiers.push_back(modifier);
//		propDef.value = new PropertyValue(propDecl->getSet(), propDecl->getGet(), propDecl->getVarDecl()->getVarType()._typeName);
//		typeDef._properties[propDecl->getVarDecl()->getVarId()] = propDef;
//	}
...
//		string funcName = varDecl->getVarId();
